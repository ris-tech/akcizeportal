...
{!! Form::open(array('route' => 'poreskafilijala.store','method'=>'POST')) !!}
<div class="row mb-3 p-3 shadow">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <input class="form-control" id="ime" name="ime" placeholder="Ime Poreske Filijale">
        </div>
    </div>
</div>
