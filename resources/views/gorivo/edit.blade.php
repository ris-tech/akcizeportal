...
@endif
{!! Form::model($goriva, ['method' => 'PATCH','route' => ['gorivo.update', $goriva->id]]) !!}
<div class="row mb-3 p-3 shadow">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <input class="form-control" id="ime" name="ime" placeholder="Naziv goriva" value="{{ $goriva->ime }}">
        </div>
    </div>
</div>
<div class="row mb-3 p-3 shadow">
