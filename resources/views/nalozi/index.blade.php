...
<table class="table table-bordered">
  <tr>
    ...
    <tr>
        ...
        <td>@if($nalog->evrodizel)<span class="badge bg-secondary">EVRO DIZEL</span>@endif @if($nalog->tng)<span class="badge bg-secondary">TNG</span>@endif</td>
        <td>@if($nalog->taxi)Taxi @else Obična @endif</td>
        <td>
...
<<<<<<< HEAD
                ...
                <tr>
                    ...
                    <td>
						@if($nalog->skener_knjizna_odobrenja_id != NULL)
							{{ $nalog->skener_knjizna_odobrenja->name }}
						@else
							Nema
						@endif</td>
=======
