...
<div class="ugovor-form">
  <page size="A4">
    ...
    <br><br>
    <span class="paragraph2">-</span><b>BRANKO MATIĆ PR</b> ,15300 Лозница ул. Дринска бр. 21, ПИБ:108573222 кога заступа директор<br>
    <span class="paragraph"></span>Бранко Матић  у даљем тексту <b>наручилац посла</b>.<br><br><br>
  ...
  <page size="A4">
    ...
    <span class="paragraph"></span>Наручилац посла се обавезује да ће по достављању фактуре извршиоца посла из става 1 овог члана уплатити износ од   20  % према донетом решењу надлежне организационе јединице Пореске управе на текући рачун извршиоца посла бр.160-527679-79 Banca Intesa најкасније у року од 3 (три) дана по достављању фактуре. <br>
  ...
  <page size="A4">
    ...
    <span class="paragraph"></span>Овај уговор ступа на снагу 28.04.2023.године.<br><br><br>
    <span class="paragraph"></span>У Лозници, 28.04.2023.године<br><br><br>
    <table width="100%">
      <tr>
      ...
      <tr>
        <td width="50%" style="text-align: center;">
          <img style="width:60%;" src="{{ asset('assets/ksk74u4ijs9IJge8Jjeh-hdjsjese974hjskjr774hs.png') }}">
        </td>
